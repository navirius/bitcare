...
namespace eSoft.Serializer.TypeSerializers.WellKnown.Int64_StorageFormats
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class ValueInConfig : Int64StorageBase
    {
        ...
        // Default constructor
        public ValueInConfig() : base(Int64StorageFormats.ValueInConfig, UsedConfigBitsForValue) { }

        // Storage constructor
        public ValueInConfig(Int64 valueToStore) : this() 
        {
            Value = (int)valueToStore;
        }
