...
namespace eSoft.Serializer
{
    ...
    public partial class Serializer
    {
        ...
        public static byte[] SerializeInt16(Int16 valueToSerialize)
        {
            ...
            // Encode value
            byte[] encodedValue = BitToolkit.ConvertInt16ToByteArray(valueToSerialize);
        ...
        public static Int16 DeserializeInt16(byte[] serializedData)
        {
            // 1 or 2 bits for config (lsb)
            // x1 - stored in this byte (on rest 7 bits)
            // 00 - has default value 0
            ...
            switch (configCase)
            {
                case 2: // 10 - stored in next few bytes - then next 2 bits says on how many bytes the value has been stored
                    return BitToolkit.ConvertByteArrayToInt16(serializedData,1);
