...
{
    public class TestDefinition4PublicMembersAccessors
    {
        ...
        public static void SerTests()
        {
            ...
            byte[] serResult = BitCareSerializer.ByPubMembers.v1.PersonSerializer.Serialize_PerfTests_Classes_AzureEntityFramework_Person(m_TestObject, CompressionType.Internal);
        ...
        {
            byte[] serResult = BitCareSerializer.ByPubMembers.v1.PersonSerializer.Serialize_PerfTests_Classes_AzureEntityFramework_Person(m_TestObject, CompressionType.Internal);
            BitCareSerializer.ByPubMembers.v1.PersonSerializer.Deserialize_PerfTests_Classes_AzureEntityFramework_Person(serResult);
        }
